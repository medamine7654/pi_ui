...
class SampleDataFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        // Create Logements
        $this->createLogements($manager, $adminUser, $categories);
    ...
    private function createLogements(ObjectManager $manager, User $host, array $categories): void
    {
        $logements = [
            [
            ...
            [
                'name' => 'Charming Traditional House in Medina',
                'category' => 'House',
            ...
            [
                'name' => 'Modern 2BR Apartment in Ariana',
                'category' => 'Apartment',
            ...
            [
                'name' => 'Beachfront Apartment in Hammamet',
                'category' => 'Apartment',
            ...
            [
                'name' => 'Countryside Villa in Nabeul',
                'category' => 'House',
                ...
                'address' => 'Route de Menzel Temime Km 5',
                'city' => 'Nabeul',
                'country' => 'Tunisia',
            ...
            [
                'name' => 'Budget-Friendly Room in Carthage',
                'category' => 'Room',
            ...
            [
                'name' => 'Family House in Ben Arous',
                'category' => 'House',
            ...
            [
                'name' => 'Artistic Loft in Sidi Bou Said',
                'category' => 'Apartment',
